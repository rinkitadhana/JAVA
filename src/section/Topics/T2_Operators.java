...
public class T2_Operators {
    ...
    Here Condition is the expression to be evaluated which will return the boolean value.
    If the Condition result is True then Statement1 will be executed. If the Condition result is false then Statement2 will be executed.
